...
let errorData = document.querySelector(".textLog__warn")
  ...
  if(dataInf.length > 0){
    ...
    const found = dataInf.find(element => element.email == email.value && element.contraseña == pass.value)
    ...
    //   if(email.value == e.email && pass.value == e.contraseña){
...
const regForm = (e) =>{
  ...
  let btnInicia = document.querySelector(".btn__sesion--log")
   ...
   if(dataName.value == "" || dataName.value < 3 || dataEmail.value == "" || contraseña.value == ""){
    ...
    checkEmail.classList.remove("text__warn--show")
      ...
      dataUsers.push({id:conta,email:dataEmail.value, contraseña:contraseña.value, name:dataName.value, img: ""})
